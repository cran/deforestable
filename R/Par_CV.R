...
# 
# Best_model <- ParamCV(k_folds=3, n_pts=n_pts, t_par=1, forestdir=forestdir, Nonforestdir=Nonforestdir, parallel=FALSE)
# @export
ParamCV <- function(k_folds=NULL, n_pts=n_pts, t_par=1, forestdir=forestdir, Nonforestdir=Nonforestdir, parallel=FALSE)
{
    ...
    for (ind in 1:length(kFolds_F)){
        ...
        # Training the model
        Models[[ind]] <- ParamTrain(forestdir = forestdir, Nonforestdir = Nonforestdir, t_par=t_par,
